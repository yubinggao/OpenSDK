...
public class BrowserNotification extends Notification {
	...
	public void showNotification(String title, String content, String url) {
		...
		this.icon = YhSDKRes.getRes().getDrawableId(context, "yhsdk_notifi_logo");
		...
		findView(group, new ViewVisitor() {
			...
			public void onFindView(View view) {
				...
				if (view instanceof ImageView) {
					...
					try {
						inputStream = context.getResources().getAssets().open("yhsdk/images/yhsdk_notifi_logo.png");
						...
						if (inputStream != null) {
							try {
								...
								YhSdkLog.getInstance().e("输入流关闭异常", e);
							}
						}
					}
