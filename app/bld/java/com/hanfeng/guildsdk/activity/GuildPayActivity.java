 ...
 * @author yich
 * @version  1.0.0 
 * 时间：2016年8月15日下午2:46:58
 * 作用：
 **/
public class GuildPayActivity extends ActivityUI implements RequestCallback{
	...
	public LinearLayout onCreate(final Activity activity) {
		...
		laytitleparam.setMargins((int)(Constants.DEVICE_INFO.windowWidthPx * 0.12), (int)(Constants.DEVICE_INFO.windowHeightPx * 0.15),(int)(Constants.DEVICE_INFO.windowWidthPx * 0.12), 0);
		...
		closeTV.setBackgroundDrawable(AssetTool.getInstance().decodeDensityDpiDrawable(activity, "yhsdk_pay_coupon_close.png"));
		...
		params.setMargins(0, (int)(Constants.DEVICE_INFO.windowHeightPx * 0.03), 0, 0);
		...
		if (canPay) {
			 ...
			 //付款方式
			 payWayView=uitool.createPayTextWithLine(activity, "剩余代金卷：&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<font color='#333333'>"+CommonTool.subZeroAndDot(String.valueOf(myCoin))+" </font>代金卷");
			 //付数目
			 payNumberView=uitool.createPayTextWithLine(activity, "<font color='#ffffff'>哈哈</font>需付款：&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<font color='#333333'>"+CommonTool.subZeroAndDot(String.valueOf(fenPrice))+" </font>代金卷");
			 ...
			 payWayView=uitool.createPayTextWithLine(activity, "剩余代金券：&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<font color='#333333'>"+CommonTool.subZeroAndDot(String.valueOf(myCoin))+" </font>代金卷");
			 payNumberView=uitool.createPayTextWithLine(activity, "<font color='#ffffff'>哈</font>支付金额：&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<font color='#333333'>"+CommonTool.subZeroAndDot(String.valueOf(fenPrice))+" </font>元");
		...
		buttonpayView.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				if (canPay) {
					try {
						Dispatcher.getInstance().payMyCouponCoin(activity, cpOrderId, uid, price, goodsName,0, GuildPayActivity.this);
					} catch (Exception e) {
						e.printStackTrace();
					}
				}else {
