...
final class PhoneVerifyCodeActivity extends ActivityUI {
	...
	public LinearLayout onCreate(final Activity activity) {
		...
		verifySubBtn.setMargins(0, (int) (Constants.DEVICE_INFO.windowHeightPx * 0.05), 0, (int) (Constants.DEVICE_INFO.windowHeightPx * 0.03));
