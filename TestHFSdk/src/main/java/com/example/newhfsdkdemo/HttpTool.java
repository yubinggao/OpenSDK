...
public final class HttpTool {
	 ...
	 * @return HttpResult
	 */
	public static HttpResultBean get(String url, String encode) {
	...
	public static HttpResultBean post(String url, String requestData) {
		return post(url, requestData, UTF8);
	}
	 ...
	 * @return HttpResult
	 */
	public static HttpResultBean post(String url, String requestData, String encode) {
		HttpURLConnection con = null;
	...
	public static HttpResultBean httpsPost(String url, String requestData) {
	 ...
	 * @return
	 */
	public static HttpResultBean httpsPost(String url, String requestData, String encode) {
	...
	public static HttpResultBean httpsGet(String url) {
	 ...
	 * @return HttpResult
	 */
	public static HttpResultBean httpsGet(String url, String encode) {
		HttpsURLConnection conn = null;
		InputStream in = null;
		HttpResultBean result = new HttpResultBean();
		try {
